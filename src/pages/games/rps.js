...
import { totalDraw, totalLoss, totalReset, totalScore, totalWin } from '../../store/point/action'
...
const RPS = () => {
    ...
    const userGame = useSelector(state => state.gamesReducer)
            ...
            <section className='dark-mode'>
                <div className="container">
                    ...
                    <div className="row d-flex justify-content-center">
                        <button className='btn btn-danger btn-flat' type='submit'>quit and save</button>
                    </div>
                </div>
            </section>
        </>
